...
String _activityDocIdFromTitle(String title) {
  return title
      .toLowerCase()
    ...
    return _PageShell(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          const _SectionTitle('Participant snapshot'),
          const SizedBox(height: 10),
          ...participants.map(
            (participant) => Padding(
              padding: const EdgeInsets.only(bottom: 10),
              child: _ListInfoCard(
                title: participant,
                subtitle: 'Check the latest registration status.',
              ),
            ),
          ),
        ],
...
class _RegistrationListPage extends StatelessWidget {
  const _RegistrationListPage({
    required this.activityTitle,
  ...
  Widget build(BuildContext context) {
    return _PageShell(
      ...
      child: Column(
        ...
        children: [
          _RoleBanner(
            role: CoCurriculumRole.pusatAdab,
            title: activityTitle,
            subtitle: 'View student registrations for this activity.',
          ),
          const SizedBox(height: 14),
          const _SectionTitle('Registered students'),
          const SizedBox(height: 10),
          ...registrations.map(
